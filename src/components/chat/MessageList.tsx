                        ...
                        switch (part.type) {
                          ...
                          case "tool-invocation":
                            ...
                            const toolLabels: Record<string, { active: string; done: string }> = {
                              str_replace_editor: { active: "Writing code...", done: "Code written" },
                              file_manager: { active: "Managing files...", done: "Files updated" },
                            };
                            const label = toolLabels[tool.toolName] ?? { active: "Working...", done: "Done" };
                            return (
                              <div key={partIndex} className="inline-flex items-center gap-2 mt-2 px-3 py-1.5 bg-neutral-50 rounded-lg text-xs font-mono border border-neutral-200">
                                {tool.state === "result" && tool.result ? (
                                  ...
                                  <>
                                    ...
                                    <span className="text-neutral-700">{label.active}</span>
                                  </>
                                )}
                              </div>
                            );
